...
needed to technically realize the PRD requirements and the functional design.
...
1. **Existing architecture design document (`docs/architecture.md`)** - Highest priority
   - Contains the project-specific technology choices and design
...
**When updating**: Preserve the structure and content of the existing design document while updating
...
When creating the architecture design document, use the template while consulting the guide:
- Guide: ./guide.md
