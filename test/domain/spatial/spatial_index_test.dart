...
void main() {
  ...
  group('tileIndexOf', () {
    ...
    test(
      'tile centers map back to their own tile (round-trip consistency)',
      () {
  ...
  group('tilesInViewport', () {
    ...
    test(
      'a view spanning the RA 0°/360° boundary includes tiles on both sides',
      () {
    ...
    test(
      'a narrow FOV covers only part of the sky (excludes off-screen tiles)',
      () {
  ...
  group('tileCenter / tileAngularRadiusDeg', () {
    test(
      'any point inside a tile lies within the angular radius of its center',
      () {
