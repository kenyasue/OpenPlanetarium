...
void main() {
  group('Galactic.toEquatorial', () {
    test(
      'galactic center (l=0, b=0) points toward Sagittarius, RA≈266.40°/Dec≈-28.94°',
      () {
    ...
    test(
      'north galactic pole (b=90) is RA≈192.86°/Dec≈27.13° by definition',
      () {
    ...
    test(
      'points on the galactic plane (b=0) are 90° from the north galactic pole',
      () {
        final ngp = Galactic.toEquatorial(0, 90);
